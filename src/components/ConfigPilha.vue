<template>
  <div>
    <v-card
      ...
      color="#ECEFF1"
    >
      <v-card-title> Pilha Sequencial </v-card-title>

      <p class="mt-3">Selecione o tamanho da Pilha:</p>
      <v-slider
        v-model="size_array"
        class="slider"
        :max="30"
      ...
      <CodeDisplay :texts="[`var pilha[${size_array}];`]" />
    ...
    <div v-else>
      ...
      >
        ...
        <div v-if="option == 'add'">
          ...
          <CodeDisplay :texts="[`pilha.push(${value});`]" />
        ...
        <div v-if="option == 'edit'">
          ...
          <p class="text-caption">Remover item da pilha</p>
          <CodeDisplay :texts="[`pilha.pop();`]" />
          <v-btn
            @click="pop"
            class="mt-4"
            variant="outlined"
          ...
          <p class="text-caption">Remover e exibir item da pilha</p>
          <CodeDisplay :texts="[`print(pilha.pop());`]" />
          <v-btn
            @click="popE"
            class="mt-4"
            variant="outlined"
          ...
          <p class="text-caption">Exibir item no topo da pilha</p>
          <CodeDisplay :texts="[`print(pilha.topo());`]" />
          <v-btn
            @click="top"
            class="mt-4"
            variant="outlined"
